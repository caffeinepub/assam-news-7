...
import type { Article as _Article, Category as _Category, Source as _Source, Timestamp as _Timestamp, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createArticle(arg0: string, arg1: string, arg2: string, arg3: Category, arg4: string, arg5: string | null, arg6: Array<string>, arg7: boolean): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createArticle(arg0, arg1, arg2, to_candid_Category_n3(this._uploadFile, this._downloadFile, arg3), arg4, to_candid_opt_n5(this._uploadFile, this._downloadFile, arg5), arg6, arg7);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async fetchAndImportExternalNews(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.fetchAndImportExternalNews();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getArticle(arg0: bigint): Promise<Article> {
        if (this.processError) {
            try {
                ...
                return from_candid_Article_n6(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async setBreakingNews(arg0: bigint, arg1: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setBreakingNews(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async toggleArticleVisibility(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.toggleArticleVisibility(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateArticle(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: Category, arg5: string, arg6: string | null, arg7: Array<string>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateArticle(arg0, arg1, arg2, arg3, to_candid_Category_n3(this._uploadFile, this._downloadFile, arg4), arg5, to_candid_opt_n5(this._uploadFile, this._downloadFile, arg6), arg7);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_Article_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Article): Article {
...
function from_candid_Source_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Source): Source {
...
function from_candid_record_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        source: from_candid_Source_n8(_uploadFile, _downloadFile, value.source),
        tags: value.tags,
...
function from_candid_variant_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "entertainment" in value ? Category.entertainment : "national" in value ? Category.national : "local" in value ? Category.local : "technology" in value ? Category.technology : "business" in value ? Category.business : "sports" in value ? Category.sports : "world" in value ? Category.world : "health" in value ? Category.health : "politics" in value ? Category.politics : value;
}
...
function from_candid_variant_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "auto" in value ? Source.auto : "manual" in value ? Source.manual : value;
}
